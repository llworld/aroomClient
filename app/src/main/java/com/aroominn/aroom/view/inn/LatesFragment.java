...
public class LatesFragment extends BaseFragment implements BaseQuickAdapter.OnItemChildClickListener,
        BaseQuickAdapter.OnItemLongClickListener, BaseQuickAdapter.OnItemClickListener, StoryView {

    @BindView(R.id.lates_refreshLayout)
    SmartRefreshLayout mRefreshLayout;

    @BindView(R.id.lates_list)
    ...
    public int getContentViewId() {
        return R.layout.fragment_lates;
    }
