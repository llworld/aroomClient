...
public class Const {
    ...
    public static final String USER_HX_ACCOUNT = "user_hx_account";

    public static final String USER_PHONE = "user_phone";

    public static final String APP_ID = "wxbe4710a8d8bc1335";

    public static final String BUGLY_ID = "c1ac5d0a98";

    public static final String PARTNER_ID = "1441219202";

    public static final String KEY = "f387f6b92a818aab94f33b60619771e6";
    ...
    public static final String CAN_MODIFY_ACCOUNT = "can_modify_account";
    ...
    public static final String ADVERT_VISION = "advert_vision";
    ...
    public static final int MINE_UNLOGIN_LOGIN = 6;

    public static final int CHOOSE_ADDRESS_REQ = 7;

    public static final int CHOOSE_ADDRESS_RES = 8;

    public static final int NEW_ADDRESS_RESHRE = 9;
